...
app.get('/api/v2/events/:eventID/checkpoints/:checkpointID/task', api.task.show);
...
app.post('/api/v2/events/:eventID/checkpoints/:checkpointID/task', api.task.create);
...
app.put('/api/v2/events/:eventID/checkpoints/:checkpointID/task/:taskID', api.task.edit);
...
app.delete('/api/v2/events/:eventID/checkpoints/:checkpointID/task/:taskID', api.task.remove);
